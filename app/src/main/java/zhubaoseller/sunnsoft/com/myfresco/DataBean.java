...
public class DataBean {
    ...
    public static List<DropdownItemObject> getRegionProvince() {
        ...
        regionProvinceList.add(regionProvinceObj);
        regionProvinceObj = new DropdownItemObject(4, "撒旦法", "撒旦法");
        regionProvinceList.add(regionProvinceObj);
        regionProvinceObj = new DropdownItemObject(5, "请问", "请问");
        regionProvinceList.add(regionProvinceObj);
        regionProvinceObj = new DropdownItemObject(6, "热", "热");
        regionProvinceList.add(regionProvinceObj);
        regionProvinceObj = new DropdownItemObject(7, "我", "我");
        regionProvinceList.add(regionProvinceObj);
        regionProvinceObj = new DropdownItemObject(8, "个", "个");
        regionProvinceList.add(regionProvinceObj);
    ...
    public static List<DropdownItemObject> getRegionArea() {
        ...
        regionAreaList.add(regionAreaObj);
        regionAreaObj = new DropdownItemObject(1, 1, 3, "1", "1");
        regionAreaList.add(regionAreaObj);
        regionAreaObj = new DropdownItemObject(1, 1, 4, "2", "2");
        regionAreaList.add(regionAreaObj);
        regionAreaObj = new DropdownItemObject(1, 1, 5, "3", "3");
        regionAreaList.add(regionAreaObj);
        regionAreaObj = new DropdownItemObject(1, 1, 6, "4", "4");
        regionAreaList.add(regionAreaObj);
        regionAreaObj = new DropdownItemObject(1, 1, 7, "5", "5");
        regionAreaList.add(regionAreaObj);
        regionAreaObj = new DropdownItemObject(1, 1, 8, "6", "6");
        regionAreaList.add(regionAreaObj);
        regionAreaObj = new DropdownItemObject(1, 1, 9, "7", "7");
        regionAreaList.add(regionAreaObj);
